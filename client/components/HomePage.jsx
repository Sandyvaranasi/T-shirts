...
export default function HomePage() {
  ...
  return (
    <div className='home'>
    <Link to={'/home'}>
      <button className='bg-primary' style={{ marginLeft: '60rem', marginBottom: '8rem' }}>Explore The Store Now</button>
    </Link>
    <div className='text-white mb-5 ' style={{ marginLeft: '15rem', fontSize: '5rem'}}>
