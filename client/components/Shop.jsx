...
<button className='bg-primary shadow p-2 mt-2  w-25 mx-5' onClick={handleOrders} >My products</button>
<button className='bg-primary shadow p-2 mt-2  w-25 mx-5' onClick={handleClick} >Add product</button>
</div>
  )
}
